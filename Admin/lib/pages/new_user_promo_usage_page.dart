...
class NewUserPromoUsagePage extends StatefulWidget {
  const NewUserPromoUsagePage({super.key});

  @override
  State<NewUserPromoUsagePage> createState() => _NewUserPromoUsagePageState();
}

class _NewUserPromoUsagePageState extends State<NewUserPromoUsagePage> {
  String _searchQuery = '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('New User Promo Usage'),
        backgroundColor: Colors.black,
        foregroundColor: Colors.white,
      ),
      body: StreamBuilder<PromoUsageStats>(
        stream: NewUserPromoService.getPromoUsageStatsStream(),
                    ...
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              _searchQuery.isEmpty
                                  ? 'No orders found with this promo'
