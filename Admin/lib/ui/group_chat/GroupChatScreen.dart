...
import 'package:brgy/widgets/group_chat_message_bubble.dart';
import 'package:brgy/widgets/typing_indicator.dart';
        ...
        child: Row(
          children: [
            ...
            IconButton(
              ...
              onPressed: _isUploading ? null : _onImagePick,
              color: Colors.orange,
            ),
            // Text input
            Expanded(
            ...
            CircleAvatar(
              ...
              child: IconButton(
                ...
                onPressed: _isUploading ? null : _onSendMessage,
              ),
            ),
          ],
        ),
