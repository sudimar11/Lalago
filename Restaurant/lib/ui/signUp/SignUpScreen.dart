...
class _SignUpState extends State<SignUpScreen> {
  ...
  bool _obscureTextConfirm = true; // To control password visibility
        ...
        Padding(
          ...
          child: Container(
            ...
            child: InternationalPhoneNumberInput(
              ...
              initialValue:
                  PhoneNumber(isoCode: 'PH'), // Default to Philippines
              selectorConfig: const SelectorConfig(
                selectorType: PhoneInputSelectorType.DIALOG,
                showFlags: true,
                setSelectorButtonAsPrefixIcon:
                    true, // Display the flag as a prefix icon
              ),
            ),
          ),
        ),
    ...
    if (_key.currentState?.validate() ?? false) {
      ...
      try {
        ...
        dynamic result =
            ...
            await FireStoreUtils.firebaseSignUpWithEmailAndPassword(
