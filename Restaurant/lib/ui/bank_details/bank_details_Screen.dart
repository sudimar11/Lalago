...
import 'package:foodie_restaurant/ui/bank_details/enter_bank_details_screen.dart';
...
class _BankDetailsScreenState extends State<BankDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: isDarkMode(context) ? Color(DARK_VIEWBG_COLOR) : Colors.white, body: isBankDetailsAdded ? showBankDetails() : addBankDetail(context));
  }
