...
class _LoginScreen extends State<LoginScreen> {
  bool _obscureTextLogin = true; // To control password visibility
            ...
            ConstrainedBox(
              ...
              child: Padding(
                ...
                child: TextFormField(
                  ...
                  obscureText:
                      _obscureTextLogin, // Use the visibility state variable
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                      ...
                      onPressed: () {
                        setState(() {
                          _obscureTextLogin =
                              !_obscureTextLogin; // Toggle visibility
                        });
                      },
                    ),
                    focusedBorder: OutlineInputBorder(
  ...
  Future<void> _login() async {
    ...
    // Save form (if you have any onSaved handlers)
