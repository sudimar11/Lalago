...
import 'package:foodie_restaurant/ui/fullScreenVideoViewer/FullScreenVideoViewer.dart';
...
class ChatScreens extends StatefulWidget {
  ...
  ChatScreens({Key? key, this.orderId, this.customerId, this.customerName, this.restaurantName, this.restaurantId, this.customerProfileImage, this.restaurantProfileImage, this.token})
      : super(key: key);
...
class _ChatScreensState extends State<ChatScreens> {
            ...
            Expanded(
              child: GestureDetector(
                ...
                child: PaginateFirestore(
                  ...
                  query: FirebaseFirestore.instance.collection('chat_restaurant').doc(widget.orderId).collection("thread").orderBy('createdAt', descending: false),
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            focusedBorder: OutlineInputBorder(
                              borderSide: BorderSide(color: Colors.black.withValues(alpha: 0.05), width: 0.0),
  ...
  _sendMessage(String message, Url? url, String videoThumbnail, String messageType) async {
    ...
    await FireStoreUtils.sendChatFcmMessage(widget.restaurantName.toString(), conversationModel.message.toString(), widget.token.toString());
  }
