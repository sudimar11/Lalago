...
class WalletScreenState extends State<WalletScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldKey,
      body: Container(
        color: isDarkMode(context) ? Color(DARK_VIEWBG_COLOR) : Colors.black.withValues(alpha: 0.03),
        child: Stack(
          children: [
            Padding(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ClipOval(
                            child: Container(
                              color: Color(COLOR_PRIMARY).withValues(alpha: 0.06),
                              child: Padding(
                                padding: const EdgeInsets.all(10.0),
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ClipOval(
                              child: Container(
                                color: Color(COLOR_PRIMARY).withValues(alpha: 0.05),
                                child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Icon(Icons.account_balance_wallet_rounded, size: 28, color: Color(COLOR_PRIMARY)),
                                ),
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.w600,
                                  color: isDarkMode(context) ? Colors.white.withValues(alpha: 0.9) : Colors.black.withValues(alpha: 0.9),
                                ),
                              ),
                              SizedBox(
                                height: 10,
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: isDarkMode(context) ? Colors.white.withValues(alpha: 0.7) : Colors.black.withValues(alpha: 0.7),
                                ),
                              ),
                              SizedBox(
                                height: 4,
