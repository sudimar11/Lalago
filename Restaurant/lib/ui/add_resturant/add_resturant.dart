    ...
    FireStoreUtils.getDelivery().then((value) {
      setState(() {
        ...
        if (deliveryChargeModel != null &&
            !deliveryChargeModel!.vendorCanModify) {
          deliverChargeKm.text =
              deliveryChargeModel!.deliveryChargesPerKm.toString();

          minDeliveryCharge.text =
              deliveryChargeModel!.minimumDeliveryCharges.toString();

          minDeliveryChargewkm.text =
              deliveryChargeModel!.minimumDeliveryChargesWithinKm.toString();
        }
      });
    });
    ...
    if (MyAppState.currentUser!.vendorID != '') {
      await FireStoreUtils.getVendor(MyAppState.currentUser!.vendorID)
        ...
        if (deliveryChargeModel != null &&
          ...
          deliverChargeKm.text =
              vendorData!.deliveryCharge!.deliveryChargesPerKm.toString();

          minDeliveryCharge.text =
              vendorData!.deliveryCharge!.minimumDeliveryCharges.toString();
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    drawBarcode(image, Barcode.qrCode(),
                        '{"vendorid":"${MyAppState.currentUser!.vendorID}","vendorname":"${vendorData!.title}"}',
