                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text("Swap to choose card", style: TextStyle(fontSize: 18, color: isDarkMode(context) ? Colors.grey.shade500 : Colors.grey.shade500, fontWeight: FontWeight.bold)),
                    ),
                    Padding(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            Row(
                              children: [
                                Expanded(child: Text("Gift Card amount", style: TextStyle(fontSize: 16, color: isDarkMode(context) ? Colors.white : Colors.black, fontWeight: FontWeight.w700))),
                                          ...
                                          InkWell(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Container(
                                                decoration: BoxDecoration(
                                                    borderRadius: BorderRadius.all(Radius.circular(14)),
                                                    border: Border.all(color: selectedAmount != "1000" && selectedAmount != "2000" && selectedAmount != "5000" ? Color(COLOR_PRIMARY) : Colors.grey)),
                                                child: Padding(
