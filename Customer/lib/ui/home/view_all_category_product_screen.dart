  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: showLoader
          ...
          : productList.isEmpty
              ? showEmptyState("No Item found", context)
              : ListView.builder(
                  shrinkWrap: true,
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(vendorModel.title, maxLines: 1, style: TextStyle(fontFamily: "Poppinsm", fontSize: 16, fontWeight: FontWeight.w700, letterSpacing: 0.2)),
                      const SizedBox(
                        height: 5,
                      ),
                      Row(
                        children: [
                          ...
                          SizedBox(width: 5),
                          Expanded(
                            child: Text(vendorModel.location, maxLines: 1, style: TextStyle(fontFamily: "Poppinsm", color: isDarkMode(context) ? Colors.white : Colors.black.withOpacity(0.60))),
                          ),
                        ],
                      ),
                      const SizedBox(
