                                    ...
                                    FutureBuilder<List<VendorCategoryModel>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        if ((snapshot.hasData ||
                                          ...
                                          return SizedBox(
                                            height:
                                                100, // Adjust height to fit the items
                          ...
                          Center(
                            child: CarouselSlider(
                              options: CarouselOptions(
                                height:
                                    150, // Adjust the height of the carousel

                                autoPlay:
                                    false, // Automatically scroll through images
                                    ...
                                    : Container(
                                        ...
                                        child: ListView.builder(
                                          ...
                                          itemCount: vendors.length > 5
                                              ...
                                              : vendors.length,
                                          itemBuilder: (context, index) {
                                            // Clear and reload vendors before processing

                                            vendors = vendors
                                                .toSet()
                                                .toList(); // Ensure unique vendors

                                            // Sort vendors by average rating in descending order

                                            final sortedVendors = vendors
                                              ..sort((a, b) {
                                                double ratingA =
                                                    a.reviewsCount == 0
                                                        ? 0
                                                ...
                                                return ratingB.compareTo(
                                                    ratingA); // Sort descending
                                              });

                                            // Limit to top 5 vendors

                                            final topVendors =
                                                sortedVendors.take(5).toList();
                                            ...
                                            return GestureDetector(
                                              onTap: () {
                                                // Navigate to the specific restaurant details screen
                                              ...
                                              child: Card(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Row(
                                                    children: [
                                                      // Vendor Image with loading indicator
