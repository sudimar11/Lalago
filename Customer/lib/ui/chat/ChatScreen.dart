...
//                               child: Center(child: showEmptyState('No Messages Yet', description: 'Send a new message and it will show up here')),
//                             );
//                           } else {
...
//     } else {
//       showAlertDialog(context, "anErrorOccurred", "failedToSendMessage", true);
//     }
//   }
//
//   @override
...
//             if (isSuccessful) {
//               Navigator.pop(context);
//               _showAlertDialog(context, 'Block', "hasBeenBlocked".tr(args: ['${homeConversationModel.members.first.fullName()}']));
//             } else {
//               _showAlertDialog(context, 'Block', "couldNotBlock".tr(args: ['${homeConversationModel.members.first.fullName()}']));
//             }
//           },
//         ),
//         CupertinoActionSheetAction(
...
//           onPressed: () async {
//             Navigator.pop(context);
//             showProgress(context, "reportingUser", false);
//             bool isSuccessful = await _fireStoreUtils.blockUser(homeConversationModel.members.first, 'report');
//             hideProgress();
//             if (isSuccessful) {
//               Navigator.pop(context);
//               _showAlertDialog(context, 'Report', "hasblocked&reported".tr(args: ['${homeConversationModel.members.first.fullName()}']));
//             } else {
//               _showAlertDialog(context, 'Report', "Couldnotreport&block".tr(args: ['${homeConversationModel.members.first.fullName()}']));
//             }
//           },
//         ),
//       ],
