                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          "${"Fix Price" == "Fix Price" ? "${currencyModel!.symbol}" : ""}${100} ${"Percentage" == "Percentage" ? "% OFF" : "OFF"}",
                          style: TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text("valid till" + " Nov 31,2022",
                          style: TextStyle(
                              fontFamily: "Poppinsr", letterSpacing: 0.5))
                    ],
                  ),
                ],
              )),
                              ...
                              child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          'Write Any Additional Requests',
                                      hintStyle:
                                          TextStyle(color: Color(0XFF9091A4)),
                                      labelStyle:
                        ...
                        child: MaterialButton(
                          ...
                          onPressed: () async {
                            ...
                            await FireStoreUtils.sendFcmMessage(
                                dineInPlaced, widget.vendorModel.fcmToken);
                            log("||||{}" + bookTablemodel.toJson().toString());
                            reqController.text = "";
                            _selectedOccasion = "";
                            selectedPeople = "2";
                            selectedTimeSlot = DateFormat('hh:mm a')
