...
class _DineInScreenState extends State<DineInScreen> {
  ...
  Future<void> getData() async {
    await fireStoreUtils.getRestaurantNearBy().whenComplete(() {
      lstAllRestaurant = fireStoreUtils
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text("Find your restaurant",
                                style: TextStyle(
                                    fontSize: 24,
                      ...
                      StreamBuilder<List<VendorModel>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            if (snapshot.hasData ||
                              ...
                              return showEmptyState(
                                  'No Restaurant found', context);
                            }
                          }),
                      //Column(
                      //  children: [
                      //    buildTitleRow(
                      //      titleValue: "Popular Restaurant",
                      //      onClick: () {
                      //        push(
                      //          context,
