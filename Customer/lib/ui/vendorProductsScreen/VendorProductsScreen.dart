...
//                                         Text(snapshot.data!.length.toString() + " " "reviews",
//                                             style: TextStyle(
//                                               fontFamily: "Poppinsr",
//                                               letterSpacing: 0.5,
...
//             width: 10,
//           ),
//           Text(isOpen ? "Open":"Close", style: TextStyle(fontFamily: "Poppinssm", fontSize: 16, color: Color(0XFF3dae7d)))
//         ]));
//   }
//
//   resttiming() {
