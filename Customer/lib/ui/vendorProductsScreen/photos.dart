...
class _RestaurantPhotosState extends State<RestaurantPhotos> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
          appBar: AppGlobal.buildSimpleAppBar(context, "Photos"),
            ...
            child: Container(
                ...
                child: FutureBuilder<VendorModel>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    else if (snapshot.data!.photos.isEmpty) return Center(child: showEmptyState("No images are available.", context));
...
class _RestaurantMenuPhotoState extends State<RestaurantMenuPhoto> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
          appBar: AppGlobal.buildSimpleAppBar(context, "Menus"),
          body: SingleChildScrollView(
              child: Container(
                  // first tab bar view widget
                  padding: EdgeInsets.only(top: 0),
