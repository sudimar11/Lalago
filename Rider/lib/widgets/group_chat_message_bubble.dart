...
class _GroupChatMessageBubbleState extends State<GroupChatMessageBubble> {
        ...
        children: [
            ...
            Padding(
              ...
              child: Text(
                ...
                style: TextStyle(
                  ...
                  color: isDarkMode(context) ? Colors.grey.shade400 : Colors.grey.shade700,
                ),
              ),
            ),
          ],
          ...
          Row(
            ...
            children: [
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: _isMyMessage
                          ? Color(COLOR_PRIMARY)
                          : (isDarkMode(context) ? Color(DARK_CARD_BG_COLOR) : Colors.grey.shade200),
              ...
              if (_isMyMessage) ...[
                const SizedBox(width: 8),
                // Avatar for my message (optional, can be removed)
  ...
  Widget _buildReadReceipt() {
    ...
    return Icon(
      ...
      size: 14,
      color: isRead ? Colors.blue.shade300 : Colors.white70,
    );
  }
          ...
          ...widget.message.reactions.entries.map((entry) {
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isMyReaction
                      ? Color(COLOR_PRIMARY).withValues(alpha: 0.2)
