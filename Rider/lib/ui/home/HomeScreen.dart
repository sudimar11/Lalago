...
class HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _handleRestaurantArrival(String orderId) async {
    ...
    final confirmed = await DialogUtils.showRestaurantArrivalDialog(context);
    ...
    if (confirmed && mounted) {
      ...
      try {
        ...
        // Mark as shown in service
        OrderLocationService.markArrivalDialogShown(orderId);

        // Send driver message to customer
        if (currentOrder != null) {
        ...
        print('Error updating restaurant arrival confirmation: $e');
        // Show error message
        if (mounted) {
