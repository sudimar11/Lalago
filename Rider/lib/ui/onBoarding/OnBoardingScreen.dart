...
class _OnBoardingScreenState extends State<OnBoardingScreen> {
  ...
  Future<bool> setFinishedOnBoarding() async {
    try {
      ...
      if (prefs == null) {
        print(
            "⚠️ SharedPreferences unavailable, cannot mark onboarding finished");
        return false;
      }
      return await prefs.setBool(FINISHED_ON_BOARDING, true);
    } catch (e) {
      print("❌ Error setting finished onboarding: $e");
      return false;
    }
  }
}
